...
function ArticlesList() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await axios.get(`${process.env.NEXT_APP_API_URL}/api/blog/featured`);
    ...
    useEffect(() => {
        const fetchArticles = async () => {
            try {
                const res = await axios.get(`${process.env.NEXT_APP_API_URL}/api/blog/posts`);
