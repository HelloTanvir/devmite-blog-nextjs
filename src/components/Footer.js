...
function Footer() {
  return (
    <div className="bg-gray-200 dark:bg-gray-900 ">
      <div className="px-4 pt-16  w-screen sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="grid row-gap-10 mb-8 lg:grid-cols-6">
                ...
                <li className="text-gray-600 dark:text-gray-300">
                  <Link href="/">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      className="text-xl hover:text-gray-800 dark:hover:text-white transition-colors duration-200 h-6 w-6 cursor-pointer"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                      <path
            ...
            <div>
              ...
              <ul className="mt-2 space-y-2">
                <li className="text-gray-600 dark:text-gray-300">
                  <a
                    href="/"
                    className="hover:text-gray-800 dark:hover:text-white transition-colors duration-200 h-6 w-6 cursor-pointer"
                  >
                    Our Team
                  </a>
                </li>
          ...
          <div className="md:max-w-md lg:col-span-2">
            <span className="text-base font-medium tracking-wide text-gray-900 dark:text-gray-100">
              Join 1,000+ others and never miss out on new tips, tutorials, and
              more.
            </span>
            <form className="flex flex-col mt-4 md:flex-row text-gray-600 dark:text-gray-600">
              <input
                placeholder="Email"
                required
                type="text"
            ...
            <p className="mt-4 text-sm text-gray-900 dark:text-gray-100 italic">
